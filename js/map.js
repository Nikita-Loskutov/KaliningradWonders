...
function createPlaceholder(map, container) {
    console.log("Создаем заглушку для карты:", map.id); // Логируем создание заглушки
    const placeholder = document.createElement('img');
    placeholder.src = map.image;
    placeholder.alt = "Карта";
    placeholder.style = "width: 100%; height: 60%; cursor: pointer;";
